...
export const ButtonIconLeft = (props) => {
    if (props.type === "primary") {
        return (
            <button type="button" className="p-px align-middle m-1 bg-(--highlight-color) rounded-[10]">
        ...
        return (
            <button type="button" className="p-px align-middle border-1 m-1 rounded-[10]">
                <div className="flex p-2 pl-3 gap-1">
                    <span><props.icon size={20} strokeWidth={1} /></span>
                    <span className="text-[13px] content-center">{props.data}</span>
                </div>
            </button>
        )
    }
