...
const TextEmphasize = (props) => {
    return (
        <div className="relative p-px rounded-md">
            <div className="relative bg-(--background) text-(--highlight-color) p-2 pl-3 pr-3 rounded-md z-2
                            overflow-hidden">
                {props.data}
            </div>
            <>
            ...
            <div className="overflowHider absolute w-full h-full top-0 left-0 overflow-hidden rounded-md">
                <div className="glaze absolute -bottom-6 -left-10 h-[100px] w-[20vw] rounded-md z-1
